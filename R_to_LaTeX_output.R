...
stargazer(R2_table1_model1, R2_table1_model2, R2_table1_model3, se = list(clusterse_R2_table1_model1, clusterse_R2_table1_model2, clusterse_R2_table1_model3) , style = "qje", omit = c("iso3","years"), font.size = "small", omit.stat = c("f","ser"), dep.var.labels = "Incidence of Civil War\\(_{(t)}\\)", covariate.labels = c("Temperature\\(_{(t)}\\)","Temperature\\(_{(t-1)}\\)", "Precipitation", "Precipitation\\(_{(t)}\\)","GDP\\(_{(t)}\\)", "Polity Score\\(_{(t)}\\)"), title = "Robustness Check 3a: Reproduction of Output Table 1, but broadening the range of countries from 41 to 53.") 
...
stargazer(tableS6_model1, tableS6_model2, tableS6_model3, tableS6_model4, tableS6_model5, se = list(clusterse_tableS6_model1, clusterse_tableS6_model2, clusterse_tableS6_model3, clusterse_tableS6_model4, clusterse_tableS6_model5) , style = "qje", omit = c("iso3","years"), font.size = "small", omit.stat = c("f","ser"), dep.var.labels = "Incidence of Civil War\\(_{(t)}\\)", covariate.labels = c("Temperature","Temperature\\(_{(t-1)}\\)", "Precipitation", "Precipitation\\(_{(t-1)}\\)","GDP", "Polity Score"), title = "Reproduction Result of Output Table S6.") 
